        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{asset('uploads/'.$product->p_image)}}" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">{{$product->p_price}}</h3>
                    <!-- <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">পরিমাপ:</strong>
                        <form method="post" action="{{route('cart.store')}}">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="size-1" name="qty">
                                <label class="custom-control-label" for="size-1">সাড়ে চার মিলি</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="size-2" name="qty">
                                <label class="custom-control-label" for="size-2">পৌনে নয় মিলি </label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="size-3" name="qty">
                                <label class="custom-control-label" for="size-3">সাড়ে চৌদ্দ মিলি</label>
                            </div>
                        </form>
                    </div> -->
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <h4 class="mb-3">{{$product->ProductDetail->description}}</h4>
