            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    @foreach($carts as $cart)
                        ...
                        <tr>
                            <td class="align-middle"><img src="{{asset('uploads/'.$cart->product->p_image)}}" alt="" style="width: 50px;">{{$cart->product->p_name}}</td>
                            <td class="align-middle">{{$cart->product->p_price}}</td>
